                ...
                <div class="col-md-4">
                    <div class="box box-widget">
                        <div class="box-header with-border">
                            ...
                            <form id="form-photo" class="text-center" action="/avatar_upload.php" method="post" enctype="multipart/form-data">
                                <div class="col-md-12">
                        ...
                        <div class="box-footer no-padding" style="display: block;">
                            <ul class="nav nav-pills nav-stacked" id="profil-navigation">
                                <li><a href="javascript:;" class="profil-content-loader" alt="my-profil"><i class="fa fa-inbox"></i> Profil</a></li>
                                ...
                                <li><a href="javascript:;" class="profil-content-loader" alt="my-kredit"><i class="fa fa-filter"></i> Kredit </a></li>
                            </ul>
                        </div><!-- /.box-body -->
                    </div>
                </div>
